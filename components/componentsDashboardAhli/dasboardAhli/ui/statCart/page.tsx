...
export default function StatisticCard({ permintaanBaru, konsultasiAktif, selesai }: Props) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
      <div className="bg-white p-6 rounded-2xl shadow-sm flex items-center gap-5 border border-white">
        ...
        <div>
          ...
          <h2 className="text-3xl font-bold text-slate-800">{permintaanBaru}</h2>
        </div>
      </div>
      ...
      <div className="bg-white p-6 rounded-2xl shadow-sm flex items-center gap-5 border border-white">
        ...
        <div>
          ...
          <h2 className="text-3xl font-bold text-slate-800">{konsultasiAktif}</h2>
        </div>
      </div>
