...
// ─── Mock Data (8 artikel supaya scroll aktif) ────────────────────────────────
...
export default function ContainerArtikel() {
  ...
  // Tinggi 1 baris tabel ≈ 72px, max tampil 5 baris = 360px
      ...
      <div className="min-h-screen bg-[#f0f4fb] p-3 sm:p-4 md:p-6 font-sans">
        ...
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 mb-4 sm:mb-6">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            <button className="flex items-center gap-2 bg-blue-500 hover:bg-blue-600 text-white rounded-xl px-3 sm:px-4 py-2 text-xs sm:text-sm font-semibold shadow-sm transition-colors">
              <Upload size={15} />
              Upload Artikel
            </button>
        ...
        <div className="bg-white rounded-2xl shadow-sm p-4 sm:p-6">
          ...
          {/* ── Desktop: table dengan scroll vertikal otomatis jika > 5 baris ── */}
          <div className="hidden sm:block">
            {/* Header tabel — FIXED, tidak ikut scroll */}
            ...
            {/* Body tabel — scroll vertikal otomatis jika melebihi 5 baris */}
